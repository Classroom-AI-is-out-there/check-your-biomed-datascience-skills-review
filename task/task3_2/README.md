# Task 3.2: clustering biomedical modeling
...
| Item | Required value |
|---|---|
| Training data | `dataset/task3_2/train.npz` |
| Test-feature data | `dataset/task3_2/test_features.npz` |
| Local output | `outputs/task3_2_predictions.csv` |
| Exact columns | `image_id`, `prediction` (no additional columns) |
| Rows | exactly 900, equal to the test examples |
...
output_path = get_output_path("task3_2")
